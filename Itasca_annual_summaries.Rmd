...
head(data)#use this if you have a working table saved as ALL.csv.
head(data$date.time)
...
END <- as.POSIXct("2020-12-31 00:00:00", tz = "")
...
write_csv(annual.sums.df.OCT, "annual_sums_OCT_v1.csv") 
```
