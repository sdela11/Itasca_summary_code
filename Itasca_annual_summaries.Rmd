...
annual.sums.df <- data %>% 
  subset.data.frame(date.time >= as.POSIXct("2020-01-01") & date.time <= as.POSIXct("2020-08-25")) 
annual.sums.df <- annual.sums.df %>% 
  subset.data.frame(date.time <= as.POSIXct("2020-09-30") | date.time >= as.POSIXct("2020-12-31"))
